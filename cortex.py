...
def store_biometrics(record):
    sql = """
        ...
        ON CONFLICT (date) DO UPDATE SET
            sleep_duration_min      = COALESCE(EXCLUDED.sleep_duration_min,   biometrics.sleep_duration_min),
            sleep_efficiency_pct    = COALESCE(EXCLUDED.sleep_efficiency_pct, biometrics.sleep_efficiency_pct),
            deep_sleep_min          = COALESCE(EXCLUDED.deep_sleep_min,       biometrics.deep_sleep_min),
            rem_sleep_min           = COALESCE(EXCLUDED.rem_sleep_min,        biometrics.rem_sleep_min),
            light_sleep_min         = COALESCE(EXCLUDED.light_sleep_min,      biometrics.light_sleep_min),
            awake_min               = COALESCE(EXCLUDED.awake_min,            biometrics.awake_min),
            time_in_bed_min         = COALESCE(EXCLUDED.time_in_bed_min,      biometrics.time_in_bed_min),
            hrv_ms                  = COALESCE(EXCLUDED.hrv_ms,               biometrics.hrv_ms),
            hrv_deep_rmssd          = COALESCE(EXCLUDED.hrv_deep_rmssd,       biometrics.hrv_deep_rmssd),
            rhr_bpm                 = COALESCE(EXCLUDED.rhr_bpm,              biometrics.rhr_bpm),
            spo2_avg_pct            = COALESCE(EXCLUDED.spo2_avg_pct,         biometrics.spo2_avg_pct),
            spo2_min_pct            = COALESCE(EXCLUDED.spo2_min_pct,         biometrics.spo2_min_pct),
            spo2_max_pct            = COALESCE(EXCLUDED.spo2_max_pct,         biometrics.spo2_max_pct),
            respiratory_rate        = COALESCE(EXCLUDED.respiratory_rate,     biometrics.respiratory_rate),
            steps                   = COALESCE(EXCLUDED.steps,                biometrics.steps),
            active_zone_min         = COALESCE(EXCLUDED.active_zone_min,      biometrics.active_zone_min),
            very_active_min         = COALESCE(EXCLUDED.very_active_min,      biometrics.very_active_min),
            fairly_active_min       = COALESCE(EXCLUDED.fairly_active_min,    biometrics.fairly_active_min),
            lightly_active_min      = COALESCE(EXCLUDED.lightly_active_min,   biometrics.lightly_active_min),
            sedentary_min           = COALESCE(EXCLUDED.sedentary_min,        biometrics.sedentary_min),
            calories_burned         = COALESCE(EXCLUDED.calories_burned,      biometrics.calories_burned),
            distance_km             = COALESCE(EXCLUDED.distance_km,          biometrics.distance_km),
            vo2_max                 = COALESCE(EXCLUDED.vo2_max,              biometrics.vo2_max),
            time_in_fat_burn_min    = COALESCE(EXCLUDED.time_in_fat_burn_min, biometrics.time_in_fat_burn_min),
            time_in_cardio_min      = COALESCE(EXCLUDED.time_in_cardio_min,   biometrics.time_in_cardio_min),
            time_in_peak_min        = COALESCE(EXCLUDED.time_in_peak_min,     biometrics.time_in_peak_min);
    """
